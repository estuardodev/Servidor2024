...
namespace ServidorASP.Controllers
{
    public class PortafolioController : Controller
    {
        ...
        public IActionResult RobotsTxt()
        {
            ...
            var filePath = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "Portafolio", "txt", "robots.txt");
        ...
        {
            // Ruta del archivo de texto en la carpeta wwwroot
            var filePath = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "Portafolio", "txt", "app-ads.txt");
